...
'''
    ...
    def _call_api(self, prompt, stage_name):
        ...
        try:
            ...
            logger.error(f"Raw content: {content if 'content' in locals() else 'None'}")
            return {}
    ...
    def _build_stage_prompt(self, stage, posts, employee_info):
        ...
        if stage == 'risk':
            ...
            {{
                ...
                "threat_surface": "string summary or object"
            }}
            '''
            ...
            {{
                ...
                "social_network": "string summary or object"
            }}
            '''
